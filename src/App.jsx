        ...
        <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 24px", height: 72, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 18, flex: 1, justifyContent: "flex-end" }}>
            <div style={{ position: "relative", display: "flex", alignItems: "center" }} className="mobile-hide">
              <Search size={13} style={{ position: "absolute", left: 10, color: "#b0a89e", pointerEvents: "none" }} />
              <input placeholder="Search..." style={{ height: 34, paddingLeft: 30, paddingRight: 12, border: "1px solid #e2ddd6", borderRadius: 2, fontSize: 11, color: "#1a1412", background: "#faf8f5", outline: "none", width: 140, fontFamily: "'Outfit',sans-serif", letterSpacing: .3 }} onFocus={e => e.target.style.borderColor = "#1a1412"} onBlur={e => e.target.style.borderColor = "#e2ddd6"} />
            </div>
            <span className="mobile-hide" style={{ fontSize: 11, letterSpacing: 1, color: "#7a6e64", cursor: "pointer", fontWeight: 500, whiteSpace: "nowrap" }}>USD $</span>
            <User size={18} style={{ cursor: "pointer", color: "#7a6e64" }} />
            <div style={{ position: "relative", cursor: "pointer" }} onClick={() => setCartOpen(true)}>
              <ShoppingBag size={18} color="#7a6e64" />
