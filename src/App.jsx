...
const PRODUCTS = [
  ...
  { id: 13, name: "Monsoon Deep Maroon Lehenga", price: 549, cat: "Lehengas", badge: "New Arrival", color: "linear-gradient(140deg,#2a0810,#5a1424 50%,#2a0810)", images: ["/images/Leh%201.jpg", "/images/Leh%202.jpg", "/images/Leh%203.jpg"], rating: 4.9, reviews: 12, desc: "Deep maroon lehenga with rich thread and zari embroidery. Flowing net dupatta with an ornate scalloped border — a monsoon-season showpiece.", sizes: ["XS","S","M","L","XL","Custom"] },
];
